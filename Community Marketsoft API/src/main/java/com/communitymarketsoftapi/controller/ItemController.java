...
public class ItemController {
    ...
    public ResponseEntity getAll(@RequestParam("category") String category) throws SQLException {
        subject.checkPermission("item:display");
        return new ResponseEntity<>(repo.getAllByCategory(category), HttpStatus.OK);
    }
